...
def sign_and_parity(num1):
    num_details = []
    if num1 % 2 == 0:
        num_details.append('Even')
    else: 
        num_details.append('Odd')
    if num1 > 0:
        num_details.append('Positive')
    else:
        num_details.append('Negative')
    print num_details   
...
def write_letter(recipient, title, sender):
    print 'Dear {} {}, I think you are amazing! Sincerely, {}'.format(title, recipient, sender)
